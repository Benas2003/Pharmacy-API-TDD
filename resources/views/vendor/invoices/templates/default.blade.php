    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td class="px-0">
                        @if($invoice->seller->pharmacist)
                            <p class="seller-name">
                                This consignment will be processed by - <strong>{{ $invoice->seller->pharmacist }}</strong>
                            </p>
                        @endif
                    ...
                    <td class="px-0">
                        @if($invoice->buyer->name)
                            <p class="buyer-name">
                                Department name - <strong>{{ $invoice->buyer->name }}</strong>
                            </p>
                        @endif

                        @if($invoice->buyer->date)
                            <p class="buyer-address">
                                Consignment created at - {{ $invoice->buyer->date }}
                            </p>
                        @endif
